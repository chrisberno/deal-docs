...
export function constructMetadata({
  title = "Deal Docs | A.I. Enabled Startup Docs & Datarooms",
  description = "Deal Docs is an AI-enabled document sharing platform for startups with advanced datarooms, analytics, and enterprise features.",
  image = "https://github.com/chrisberno/deal-docs/raw/main/public/_static/meta-image.png",
  favicon = "/favicon.ico",
  noIndex = false,
}: {
  title?: string;
